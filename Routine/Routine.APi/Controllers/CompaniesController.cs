...
namespace Routine.APi.Controllers
{
    ...
    public class CompaniesController : ControllerBase
    {
        ...
        //这种方式是模板
        [HttpPost("PostHelloWorld")]
        public async Task<OkObjectResult> PostHelloWorld([FromBody]string json)
        {
            var result = await Task.Run<string>(() => json);
            return Ok(result);
        }
        #endregion
    }
